...
class APIKeyMiddleware(object):
    ...
    def _if_skip_api_key_check(self, request):
        ...
        if "skor/" in u_agent.lower() and "tts app" not in u_agent.lower() and "move" not in u_agent.lower() and "myaia" not in u_agent.lower() and "tccc" not in u_agent.lower() and "ttt" not in u_agent.lower():
            return True
